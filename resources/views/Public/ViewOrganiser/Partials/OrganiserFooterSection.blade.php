<footer id="footer" class="container-fluid">
    <div class="col-md-8 col-md-offset-2">
        <div class="col-md-3 col-xs-6 navigation">
            <h3>Navigazione</h3>
        ...
        <div class="col-md-6 col-xs-12 navigation">
            <h3>Contatti</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12" style="margin-top: 15px;margin-bottom: 10px;font-size: 11px;">
